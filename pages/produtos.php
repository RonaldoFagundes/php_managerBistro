...
if(isset($_SESSION['msgSuccess'])){          
   $msgSuccess = ($_SESSION['msgSuccess']) ;
}
...
<div class="header">
 ...
 <div>
   <a class="btn btn-primary btn-log-out"  href='../controller/login.php?action=logout&msg='  role="button">
        log out
   </a> 
 </div>
...
<div class="msg">
    ...
    <div class='row mb-3'>
     <div class='offset-sm-3  col-sm-6'>
      ...
      <div class='alert alert-warning alert-dismissible fade show' role='alert'>
           <strong class='msgInfo'>$msgError</strong> 
           <button type='button' class='btn-close' data-bs-dismiss='alert' aria-label='Close'></button>
      </div>
 ...
 ?>
      <script> 
        const modal = document.getElementById('insert');    
